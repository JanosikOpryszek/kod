...
printf("\n*-----------------------------------------*\n");
printf("Temperatura        0105    5         A-40 \n");    
printf("Fuel presure       010A   10         3A   \n");    
printf(" Intake preasuere  010B   11         A    \n");    
printf(" Engine RPM        010C   12   256A+B/4   \n");    
printf("Intake temp air    010F   15         A-40 \n");   
printf("\n*-----------------------------------------*\n");
...
printf("  ");
*/
printf("\nwartosci readbuffera char po kolei:\n");
printf("%c\n",read_buffer[5]);
printf("%c\n",read_buffer[6]);
printf("%c\n",read_buffer[7]);
printf("%c\n",read_buffer[8]);
